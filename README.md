...
through IoC-Collaboration + Shared Ontology + Shared Intent + Shared Context +
Shared Reasoning ("AFTER").
...
**Enable IoC-Collaboration** switches to the AFTER flow, where the agents
...
Prototype controls: **Reset**, **Before**, **Enable IoC-Collaboration**, **Advance**,
